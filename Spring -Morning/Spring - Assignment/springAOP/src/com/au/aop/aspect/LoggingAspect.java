...
//	}
	...
	// show message after execution public String get*() method and store returing value into value 
	 @AfterReturning(pointcut="execution(public String get*(..))", returning="value") 
	   public void afterReturning(String value) throws Throwable 
	    {
	        System.out.println("after retuening advice value " + value);
	       
	    }
	 
	
	  // show meassage when call getTriangle method 
	  //because in getTriangle have statement throw throw new NullPointerException("not found");
